...
driveFolders=( [folders]='1pjJtrMPNy9Rbwqh7Zx4UitlSRSdSkAg-' \
...
#mimeType=( 'gdrawing' 'gfolder' 'gdocument' \
#		      'gpresentation' 'gspreadsheet' 'gdirectory' \
#		      'gfusion' 'gsite' 'gdoc' 'gform' 'gscript' 'gsheet' )

types=( 'folders' 'forms' \
		  'document' 'drawings' \
		  'presentation' 'spreadsheets' 'file')
